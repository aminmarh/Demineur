...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.LabelChoisirFichier.Size = New System.Drawing.Size(378, 20)
        Me.LabelChoisirFichier.TabIndex = 7
        Me.LabelChoisirFichier.Text = "Veuillez sélectionner un fichier dans l'onglet ""Option"""
        '
        'Label2
        '
        ...
        Me.Label2.Text = "Veuillez sélectionner un mode jeu"
        '
        'Form1
        '
